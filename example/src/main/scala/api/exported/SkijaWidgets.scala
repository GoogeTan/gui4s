...
type SkijaPlacedWidget[F[_], MeasurementUnit, UpdateError, PlaceError, Event, DownEvent] =
  Widget[SkijaUpdateT[F, UpdateError, MeasurementUnit, Event], SkijaPlaceT[F, MeasurementUnit, PlaceError], SkijaDraw[F, OglGlfwWindow[F]], SkijaRecomposition[F], DownEvent]
