...
object SkijaUpdate:
  ...
  def liftF[IO[_] : Monad,  UpdateError, MeasurementUnit, Event, Value](io : IO[Value]) : SkijaUpdate[IO,  UpdateError, MeasurementUnit, Event, Value] =
  ...
  def raiseError[IO[_] : Applicative, UpdateError, MeasurementUnit, Event, Value](error : UpdateError) : SkijaUpdate[IO, UpdateError, MeasurementUnit, Event, Value] =
