...
final class GlfwForeignFunctionInterface[
  F[_] : ForeignFunctionInterface as I,
  Error
](makeError : (code : Int, text : String) => Error)(using M : MonadError[F, Error]) extends ForeignFunctionInterface[F]:
...
end GlfwForeignFunctionInterface
