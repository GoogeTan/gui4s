...
public class Ch15HelloTriangle {
    ...
    private static class HelloTriangleApplication {
        ...
        private SPIRV shaderVert() {
            return ShaderSPIRVUtils.compileShader("shaders/shader_base.vert", "#version 450\n" +
        ...
        private SPIRV shaderFRAG() {
            return   ShaderSPIRVUtils.compileShader("shaders/shader_base.frag", "#version 450\n" +
                    "#extension GL_ARB_separate_shader_objects : enable\n" +
                    "\n" +
                    ...
                    "\n" +
                    "void main() {\n" +
                    "fragoutColor = vec4(fragColor, 1.0);\n" +
                    "}", FRAGMENT_SHADER);
        }
        ...
        private void createGraphicsPipeline() {
            ...
            try(MemoryStack stack = stackPush()) {
                ...
                SPIRV vertShaderSPIRV = shaderVert();// compileShaderFile("shaders/09_shader_base.vert", VERTEX_SHADER);
                SPIRV fragShaderSPIRV = shaderFRAG(); //compileShaderFile("shaders/09_shader_base.frag", FRAGMENT_SHADER);
