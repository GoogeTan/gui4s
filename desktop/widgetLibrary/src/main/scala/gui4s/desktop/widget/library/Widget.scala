...
type WidgetHandlesEvent[-EnvironmentalEvent, +UpdatedWidget] = (pathToParent: Path, event: EnvironmentalEvent) => UpdatedWidget
...
enum Widget[
  ...
  case ValueWrapper[
    T, Update_[_] : Functor, Place_[_] : Functor, Draw_, RecompositionReaction_, EnvironmentalEvent_
  ](
    valueToDecorate: T,
